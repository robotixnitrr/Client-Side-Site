...
const Team = () => {
  return (
    <div>
      ...
      <div className="headCoordinators">
      <div className="container">
          <div className="section-header text-center">
            <h2>Steering Body</h2>
          </div>
      ...
      <div className="coreCoordinators">
      ...
      <div className="executive">
        ...
        <div className="container">
          ...
          <div className="row">
            ...
            <div className="teamItem3">
              <div className="teamText2">
                <h2>Daksh Tripathi</h2>
                <center>
                  Executive
                  <br />
                  Technical Domain
      ...
      <div className="members">
        ...
        <div className="container">
          ...
          <div className="teamItem3">
            ...
            <div className="teamItem3">
              <div className="teamText1">
                <h2>Poornaditya Das Manikpuri</h2>
                <center>
                  Member
                  <br />
                  Documentation Domain
